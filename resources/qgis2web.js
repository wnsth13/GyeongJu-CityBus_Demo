...
map.getView().fit([14385574.744779, 4267421.225951, 14395079.601668, 4281393.348157], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">10 route</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (19 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '새천년미소 2025년 노선도입니다.';
            }
